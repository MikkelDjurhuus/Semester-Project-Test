...
{
    public class DOC_TestController
    {
        [Fact]
        public async void TestGetBooksFromCityMock()
        {
            ...
            var _res = await _controller.LoadBooksFromCity("Abu Dhabi", DbTypesEnum.Document);
        ...
        public async void TestLoadBooksFromAuthorBook()
        {
            ...
            var _authorStruct = await _controller.LoadBooksFromAuthor("J. Arthur Gibbs", DbTypesEnum.Document);
        ...
        [Fact]
        public async void TestGetAllDbTypesDoc()
        {
            var _controller = new DatabaseApiController();
        ...
        public async void TestLoadGeolocationsFromBookTitle()
        {
            ...
            var _res = await _controller.LoadGeolocationsFromBookTitle("Buddy And Brighteyes Pigg", DbTypesEnum.Document);
        ...
        public async void TestLoadGeoMarkersFromGeolocationsBook()
        {
            ...
            var _data = await _controller.LoadGeoMarkersFromGeolocations(10, 45, DbTypesEnum.Document);
