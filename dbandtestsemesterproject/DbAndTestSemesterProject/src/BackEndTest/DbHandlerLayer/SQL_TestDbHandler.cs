...
{
    public class SQL_TestDbHandler
    {
        [Fact]
        public async void TestGetBooksFromAuthorCities()
        {
            ...
            var _authorStruct = await _dbHandler.GetBooksFromAuthor("J. Arthur Gibbs", DbTypesEnum.SQL);
        ...
        public async void TestGetMockGeolocationsFromBookTitle()
        {
            ...
            var _res = await _dbHandler.GetGeolocationsFromBookTitle("Buddy And Brighteyes Pigg", DbTypesEnum.SQL);
        ...
        public async void TestCreateMockGeolocationMarkersBook()
        {
            ...
            var _data = await _dbHandler.GetGeoMarkersFromGeolocations(10, 45, DbTypesEnum.SQL);
