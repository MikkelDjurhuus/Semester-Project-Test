...
{
    public class GRAPH_TestDbHandler
    {
        [Fact]
        public async void TestGetBooksFromAuthorCities()
        {
            ...
            var _authorStruct = await _dbHandler.GetBooksFromAuthor("J. Arthur Gibbs", DbTypesEnum.Graph);
        ...
        public async void TestGetMockGeolocationsFromBookTitle()
        {
            ...
            var _res = await _dbHandler.GetGeolocationsFromBookTitle("Buddy And Brighteyes Pigg", DbTypesEnum.Graph);
        ...
        public async void TestCreateMockGeolocationMarkersBook()
        {
            ...
            var _data = await _dbHandler.GetGeoMarkersFromGeolocations(10, 45, DbTypesEnum.Graph);
