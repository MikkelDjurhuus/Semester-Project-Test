...
formatter( new Date( 2010, 45, 30, 17, 55 ) );
// > "11/30/2010"
```
...
enFormatter( new Date( 2010, 45, 30, 17, 55 ) );
// > "11/30/2010, 5:55 PM"

deFormatter( new Date( 2010, 45, 30, 17, 55 ) );
// > "30.11.2010"
```
...
| `presetValue` | `Globalize( "en" ).dateFormatter( presetValue )( new Date( 2010, 45, 1, 17, 55 ) )` |
| --- | --- |
| `{ date: "short" }` | `"11/1/10"` |
...
| locale | `Globalize( locale ).dateFormatter({ datetime: "short" })( new Date( 2010, 45, 1, 17, 55 ) )` |
| --- | --- |
| *en* | `"11/1/10, 5:55 PM"` |
...
| `skeleton` | `Globalize( "en" ).dateFormatter( skeleton )( new Date( 2010, 45, 1, 17, 55 ) )` |
| --- | --- |
| `{ skeleton: "E" }` | `"Tue"` |
...
var globalize = Globalize( "en" ),
  date = new Date( 2010, 45, 30, 17, 55 ),
...
var dates = [ new Date( 2010, 45, 30, 17, 55 ), new Date( 2015, 3, 18, 4, 25 ) ];
